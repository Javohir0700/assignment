...
typedef actionlib::SimpleActionServer<assignment::Navigate2DAction> NavServer;

float DIST_THRESHOLD = 0.1;
geometry_msgs::Point robot_current_position;

void navCallback(const assignment::Navigate2DGoal::ConstPtr& goal_point,
                 NavServer* nav_server)
{
  assignment::Navigate2DFeedback feedback_msg;
  assignment::Navigate2DResult result_msg;
